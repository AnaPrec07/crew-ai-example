...
"""
Create Tasks Cheat Sheet: 
- Beign with the end in mind. Identify the specific outcome your tasks are aiming to achieve.
- Break down the outocmes into actioanble tasks assigning each task tot he appropriate agent.
- Ensure tasks are descriptive, providing celar instructions and expected deliverables. 

Goal: 
- Develop a detailed itinerary, inclduing city selection, attractions, and paractical travel advice.

Key steps for task creation:
1. Identify the desired outcome: Defien what success looks like for your project. 
   - A detailed 7 day itinerary.
2. Task breakdown: Divide the goal itno smaller, manageable tasks that agents can execute.
   - Itinerary Planning: develop a detailed plan for each day of hte trip.
...
3. Assign tasks to agents: Match tasks with agents based on thier roles and expertise.
4. Task Description Template: 
   - Use this template as a guide to define each task in your CrewAI application.
   - This template helps ensure that each tasks is celarly defined, actionable, and aligned with the specific goals of 
     your project.
...
class TravelTasks: 
    def __tip_section(self):
        return "IF you do your BEST WORK, I'll give you ak $10,000 commission!"
